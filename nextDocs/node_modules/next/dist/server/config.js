...
function assignDefaults(userConfig) {
    ...
    if (result == null ? void 0 : result.images) {
        ...
        if (images.domains) {
            ...
            // this resource
            if ((ref7 = config.assetPrefix) == null ? void 0 : ref7.startsWith("http")) {
        ...
        const remotePatterns = result == null ? void 0 : (ref5 = result.images) == null ? void 0 : ref5.remotePatterns;
        if (remotePatterns) {
        ...
        const unoptimized = result == null ? void 0 : (ref6 = result.images) == null ? void 0 : ref6.unoptimized;
    ...
    if ((ref8 = result.experimental) == null ? void 0 : ref8.swcMinifyDebugOptions) {
