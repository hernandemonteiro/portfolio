...
class DevServer extends _nextServer.default {
                            ...
                            (ref8 = config.plugins) == null ? void 0 : ref8.forEach((plugin)=>{
                                ...
                                if (plugin && typeof plugin.definitions === "object" && plugin.definitions.__NEXT_DEFINE_ENV) {
                                    ...
                                    const newDefine = (0, _webpackConfig).getDefineEnv({
                                        ...
                                        isNodeServer,
                                        isEdgeServer,
                                        hasServerComponents: (ref17 = this.hotReloader) == null ? void 0 : ref17.hasServerComponents
                                    });
    ...
    setupWebSocketHandler(server, _req) {
        if (!this.addedUpgradeListener) {
            ...
            server = server || ((ref19 = _req == null ? void 0 : _req.originalRequest.socket) == null ? void 0 : ref19.server);
            if (!server) {
                ...
                server.on("upgrade", (req, socket, head)=>{
                    ...
                    if ((ref = req.url) == null ? void 0 : ref.startsWith(`${basePath || assetPrefix || ""}/_next/webpack-hmr`)) {
                        var ref18;
                        (ref18 = this.hotReloader) == null ? void 0 : ref18.onHMR(req, socket, head);
                    } else {
        ...
        if ((0, _isError).default(err) && err.stack) {
            try {
                ...
                if (frame.lineNumber && (frame == null ? void 0 : frame.file)) {
                    var ref, ref21, ref22, ref23, ref24, ref25;
                    const moduleId = frame.file.replace(/^(webpack-internal:\/\/\/|file:\/\/)/, "");
                    const src = (0, _middleware).getErrorSource(err);
                    const compilation = src === _constants1.COMPILER_NAMES.edgeServer ? (ref = this.hotReloader) == null ? void 0 : (ref21 = ref.edgeServerStats) == null ? void 0 : ref21.compilation : (ref22 = this.hotReloader) == null ? void 0 : (ref23 = ref22.serverStats) == null ? void 0 : ref23.compilation;
                    const source = await (0, _middleware).getSourceById(!!((ref24 = frame.file) == null ? void 0 : ref24.startsWith(_path.sep)) || !!((ref25 = frame.file) == null ? void 0 : ref25.startsWith("file:")), moduleId, compilation);
    ...
    generateRoutes() {
        ...
        fsRoutes.unshift({
            ...
            fn: async (_req, res)=>{
                ...
                res.setHeader("Content-Type", "application/json; charset=utf-8");
                var ref26;
                res.body(JSON.stringify((ref26 = (ref = this.getMiddleware()) == null ? void 0 : ref.matchers) != null ? ref26 : [])).send();
                return {
                    finished: true
                };
            }
