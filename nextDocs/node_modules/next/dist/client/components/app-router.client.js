 ...
 */ function fetchFlight(url, flightRouterState, prefetch) {
...
function fetchServerResponse(url, flightRouterState, prefetch) {
    ...
    return (0, _reactServerDomWebpack).createFromReadableStream(fetchFlight(url, flightRouterState, prefetch));
}
/**
