...
function createPagesMapping({ hasServerComponents , isDev , pageExtensions , pagePaths , pagesType , pagesDir  }) {
    const previousPages = {};
...
function getEdgeServerEntry(opts) {
    if ((0, _utils1).isMiddlewareFile(opts.page)) {
        ...
        const loaderParams = {
            ...
            page: opts.page,
            matchers: ((ref = opts.middleware) == null ? void 0 : ref.matchers) ? (0, _nextMiddlewareLoader).encodeMatchers(opts.middleware.matchers) : ""
        };
    ...
    const getEntryHandler = (mappings, pagesType)=>{
       ...
       */ if (!absolutePagePath.startsWith(_constants.ROOT_DIR_ALIAS) && /[\\\\/]_middleware$/.test(page)) {
            ...
            if ((0, _utils1).isMiddlewareFile(page)) {
                var ref;
                var ref1;
                middlewareMatchers = (ref1 = (ref = staticInfo.middleware) == null ? void 0 : ref.matchers) != null ? ref1 : [
                    {
                        regexp: ".*"
                    }, 
                ];
