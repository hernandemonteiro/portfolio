...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =_constants1.COMPILER_NAMES.server , appDir , middlewareMatchers  }) {
    var ref42, ref1, ref2, ref3, ref4, ref5, ref6, ref7, // allows add JsConfigPathsPlugin to allow hot-reloading
    ...
    if (useSWCLoader) {
        ...
        const binaryTarget = (ref21 = require("./swc")) == null ? void 0 : ref21.getBinaryMetadata == null ? void 0 : (ref22 = ref21.getBinaryMetadata()) == null ? void 0 : ref22.target;
    ...
    const getBabelOrSwcLoader = ()=>{
        ...
        return useSWCLoader ? {
            ...
            options: {
                ...
                swcCacheDir: _path.default.join(dir, (ref41 = config == null ? void 0 : config.distDir) != null ? ref41 : ".next", "cache", "swc")
            }
        } : {
    ...
    if (dev) {
        customAppAliases[`${_constants.PAGES_DIR_ALIAS}/_app`] = [
            ...pagesDir ? rawPageExtensions.reduce((prev, ext)=>{
    ...
    let webpackConfig = {
        ...
        plugins: [
            ...
            !dev && isClient && new (require("./webpack/plugins/telemetry-plugin")).TelemetryPlugin(new Map([
                ...
                [
                    "swcRelay",
                    !!((ref1 = config.compiler) == null ? void 0 : ref1.relay)
                ],
                [
                    "swcStyledComponents",
                    !!((ref2 = config.compiler) == null ? void 0 : ref2.styledComponents)
                ],
                [
                    "swcReactRemoveProperties",
                    !!((ref3 = config.compiler) == null ? void 0 : ref3.reactRemoveProperties), 
                ],
                [
                    "swcExperimentalDecorators",
                    !!(jsConfig == null ? void 0 : (ref4 = jsConfig.compilerOptions) == null ? void 0 : ref4.experimentalDecorators), 
                ],
                [
                    "swcRemoveConsole",
                    !!((ref5 = config.compiler) == null ? void 0 : ref5.removeConsole)
                ],
                [
                    "swcImportSource",
                    !!(jsConfig == null ? void 0 : (ref6 = jsConfig.compilerOptions) == null ? void 0 : ref6.jsxImportSource)
                ],
                [
                    "swcEmotion",
                    !!((ref7 = config.compiler) == null ? void 0 : ref7.emotion)
                ],
                SWCBinaryTarget, 
            ].filter(Boolean))), 
        ].filter(Boolean)
    ...
    if (resolvedBaseUrl) {
        var ref23, ref24;
        (ref23 = webpackConfig.resolve) == null ? void 0 : (ref24 = ref23.modules) == null ? void 0 : ref24.push(resolvedBaseUrl);
    }
    (ref8 = webpackConfig.resolve) == null ? void 0 : (ref9 = ref8.plugins) == null ? void 0 : ref9.unshift(new _jsconfigPathsPlugin.JsConfigPathsPlugin((jsConfig == null ? void 0 : (ref10 = jsConfig.compilerOptions) == null ? void 0 : ref10.paths) || {}, resolvedBaseUrl || dir));
    const webpack5Config = webpackConfig;
    if (isEdgeServer) {
        var ref25, ref26, ref27, ref28, ref29, ref30;
        (ref25 = webpack5Config.module) == null ? void 0 : (ref26 = ref25.rules) == null ? void 0 : ref26.unshift({
            test: /\.wasm$/,
    ...
    const configVars = JSON.stringify({
        ...
        removeConsole: (ref11 = config.compiler) == null ? void 0 : ref11.removeConsole,
        reactRemoveProperties: (ref12 = config.compiler) == null ? void 0 : ref12.reactRemoveProperties,
        styledComponents: (ref13 = config.compiler) == null ? void 0 : ref13.styledComponents,
        relay: (ref14 = config.compiler) == null ? void 0 : ref14.relay,
        emotion: (ref15 = config.compiler) == null ? void 0 : ref15.emotion,
        modularizeImports: (ref16 = config.experimental) == null ? void 0 : ref16.modularizeImports,
        legacyBrowsers: (ref17 = config.experimental) == null ? void 0 : ref17.legacyBrowsers
    });
    const cache = {
        type: "filesystem",
        // Includes:
    ...
    if (typeof config.webpack === "function") {
        ...
        if (((ref31 = webpack5Config.experiments) == null ? void 0 : ref31.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref32 = webpack5Config.experiments) == null ? void 0 : ref32.lazyCompilation) === "object" && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref33;
        const rules = ((ref33 = webpackConfig.module) == null ? void 0 : ref33.rules) || [];
    ...
    if (config.experimental.craCompat && ((ref18 = webpackConfig.module) == null ? void 0 : ref18.rules) && webpackConfig.plugins) {
    ...
    var ref34;
    const hasUserCssConfig = (ref34 = (ref19 = webpackConfig.module) == null ? void 0 : (ref20 = ref19.rules) == null ? void 0 : ref20.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include))) != null ? ref34 : false;
    if (hasUserCssConfig) {
...
function getDefineEnv({ dev , config , distDir , isClient , hasRewrites , hasReactRoot , isNodeServer , isEdgeServer , middlewareMatchers , hasServerComponents  }) {
    var ref, ref46, ref47;
    return {
        ...
        "process.env.__NEXT_IMAGE_OPTS": JSON.stringify({
            ...
            ...dev ? {
                ...
                remotePatterns: (ref46 = config.images) == null ? void 0 : ref46.remotePatterns
            } : {}
        }),
        "process.env.__NEXT_ROUTER_BASEPATH": JSON.stringify(config.basePath),
        "process.env.__NEXT_HAS_REWRITES": JSON.stringify(hasRewrites),
        "process.env.__NEXT_I18N_SUPPORT": JSON.stringify(!!config.i18n),
        "process.env.__NEXT_I18N_DOMAINS": JSON.stringify((ref47 = config.i18n) == null ? void 0 : ref47.domains),
...
function attachReactRefresh(webpackConfig, targetLoader) {
    ...
    (ref = webpackConfig.module) == null ? void 0 : (ref48 = ref.rules) == null ? void 0 : ref48.forEach((rule)=>{
